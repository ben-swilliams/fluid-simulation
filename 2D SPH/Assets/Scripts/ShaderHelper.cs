...
class ShaderHelper
{
    ...
    */
    ...
    )
    {
        ...
        kernelStaticBufferMap.Add(intermediateVelocityKernel, new string[] { "IntermediateAccelerations" });
        ...
        kernelDynamicBufferMap.Add(intermediateAccelerationKernel, new string[] { "Velocities" });
